...
const std::vector<std::string> CLOCKS = {
    "NPLSr", "NPLYb", "PTBSr", "PTBYb", "SYRTEHg", "SYRTESr2", "SYRTESrB"};
...
//
const std::vector<double> NU0 = {NU0_SR, NU0_YB, NU0_SR, NU0_YB,
                                 NU0_HG, NU0_SR, NU0_SR};
...
//
const std::vector<double> KALPHA = {KALPHA_SR, KALPHA_YB, KALPHA_SR, KALPHA_YB,
                                    KALPHA_HG, KALPHA_SR, KALPHA_SR};
...
const std::vector<std::vector<double>> LABPOS = {
    NPL_POS, NPL_POS, PTB_POS, PTB_POS, SYRTE_POS, SYRTE_POS, SYRTE_POS};
